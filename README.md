...
* Small-form-factor PC repurposing
* Memory upgrades
* SSD installation
...
* USB-based operating system installation
* Disk provisioning
* Dedicated appliance deployment
* FreeBSD-based networking platform
...
* Public infrastructure sanitization
...
│   └── 03-pfsense-initial-configuration.md
│
└── images/
    ├── 01-thinkcentre-internal-hardware.jpg
    └── 02-thinkcentre-network-ports.jpg
```

Additional sanitized installation screenshots may be added as the documentation continues to develop.

---

# Project Status

**Base pfSense Firewall Deployment: Complete ✅**
...
The ThinkCentre is now operating as the dedicated firewall/router for the homelab.

---

# How This Fits Into the Homelab

This repository represents the **firewall and routing foundation** of a larger homelab environment.
...
Each major infrastructure component is documented separately so that the projects can be reviewed, reproduced, and expanded independently.
...
The next project will document the deployment of **Pi-hole on a Raspberry Pi 4** as the centralized DNS service for the homelab.

That project will cover:
